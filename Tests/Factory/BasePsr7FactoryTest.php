 ...
 */
abstract class BasePsr7FactoryTest extends TestCase
{
    private $factory;
    private $tmpDir;

    abstract function getFactory(): HttpMessageFactoryInterface;
    ...
    public function testCreateRequest()
    {
        ...
        $this->assertEquals('/testCreateRequest?foo=1&bar[baz]=42', rawurldecode($requestTarget));
